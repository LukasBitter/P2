...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LobbyWindow_t, stringdata) + ofs \
...
const QMetaObject LobbyWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LobbyWindow.data,
      qt_meta_data_LobbyWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LobbyWindow.stringdata))
        return static_cast<void*>(const_cast< LobbyWindow*>(this));
