...
#include "../../Nicolas/welcomewindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_WelcomeWindow_t, stringdata) + ofs \
...
const QMetaObject WelcomeWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_WelcomeWindow.data,
      qt_meta_data_WelcomeWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WelcomeWindow.stringdata))
