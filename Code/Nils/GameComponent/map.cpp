...
Map::Map(GamerList &gl, const Gamer *g, QWidget *parent) :
...
Map::Map(QString create, GamerList &gl, const Gamer *g, QWidget *parent):
    QGraphicsView(parent), owner(g), scene(0), ui(0),
    percentToSend(100)
{
...
void Map::applyGamerAction(QString s)
{
...
void Map::sendSquad(Node *from, Node *to)
{
...
void Map::usePower(int nodeFromId, int nodeToId, POWER_NAME p)
{
