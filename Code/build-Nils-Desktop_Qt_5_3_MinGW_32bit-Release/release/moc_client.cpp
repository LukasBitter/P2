...
#include "../../Nils/GameConnexion/client.h"
...
QT_MOC_LITERAL(11, 151, 14)
    ...
    "Client\0errorOccured\0\0QAbstractSocket::SocketError\0"
    "socketError\0messageReciveFromServeur\0"
    "connected\0sendMessageToServer\0msg\0"
    "readFromSocket\0afterConnexion\0"
    "onErrorOccured"
};
...
void Client::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->messageReciveFromServeur((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->connected(); break;
        case 3: _t->sendMessageToServer((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 4: _t->readFromSocket(); break;
        case 5: _t->afterConnexion(); break;
        case 6: _t->onErrorOccured((*reinterpret_cast< QAbstractSocket::SocketError(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Client::errorOccured)) {
                *result = 0;
            }
        }
        {
            typedef void (Client::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Client::messageReciveFromServeur)) {
                *result = 1;
            }
        }
        {
...
// SIGNAL 0
void Client::errorOccured(QAbstractSocket::SocketError _t1)
{
...
// SIGNAL 1
void Client::messageReciveFromServeur(QString _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
