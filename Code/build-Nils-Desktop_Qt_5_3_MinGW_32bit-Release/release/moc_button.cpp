...
#include "../../Nils/GameComponent/GameInterface/button.h"
...
void Button::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Button::pressed)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Button::staticMetaObject = {
    { &QGraphicsWidget::staticMetaObject, qt_meta_stringdata_Button.data,
