...
#include "../../Nils/GameComponent/GameInterface/Powers/power.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Power_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 23, 8)
    ...
    "Power\0restorCountDown\0\0powerEnd"
};
...
void Power::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->restorCountDown(); break;
        case 1: _t->powerEnd(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Power::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Power.data,
      qt_meta_data_Power,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Power.stringdata))
